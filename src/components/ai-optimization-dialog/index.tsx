...
import { PERSONA_OPTIONS, getPersonaDescription } from "./constants";

import type { AIOptimizationDialogProps, OptimizationPersona } from "./types";
...
export type { AIOptimizationDialogProps, OptimizationPersona } from "./types";
