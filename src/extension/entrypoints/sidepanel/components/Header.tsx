...
import { UserAvatar } from "@/extension/components/auth";
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        <img src="/icons/icon-32.png" alt="PromptQueue" className="h-6 w-6" />
        <h1 className="text-sm font-black tracking-tight">PromptQueue</h1>
      </div>
