...
import { getSettings, isExtensionEnabled } from "@/backend/services/storageService";
import { ThemeMode } from "@/backend/types";
    ...
    <div className="w-80 border border-border bg-background">
      <div className="flex flex-col gap-6 p-5">
        <div className="flex flex-col items-center gap-3">
          ...
          <h1 className="text-[22px] font-bold text-foreground">PromptQueue</h1>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-2">
            <a
              href="mailto:yosefisabag@gmail.com?subject=PromptQueue - Feedback"
